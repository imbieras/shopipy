          ...
          {products.map((product) => (
            <TableRow key={product.productId}>
              ...
              <TableCell>
                ...
                <Button onClick={() => handleDeleteProduct(product.productId)} variant="destructive"
              ...
              {variations?.map((variation) => (
                <TableRow key={variation.variationId}>
                  ...
                  <TableCell>
                    ...
                    <Button onClick={() => handleDeleteVariation(variation.variationId)} variant="destructive"
                            className="mr-2">Delete</Button>
                  </TableCell>
                </TableRow>
              ))}
          ...
          {(isAddingVariation || editingVariation) && (
            <form onSubmit={handleVariationSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Select name="productState" defaultValue={editingVariation ? editingVariation.productState : ''}
                        required>
                  <SelectTrigger>
                    <SelectValue placeholder="Select a state"/>
                  </SelectTrigger>
